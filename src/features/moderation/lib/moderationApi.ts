...
export const OFFENDER_TEXT: Record<Exclude<ModerationKind, 'report_result'>, string> = {
  ...
  warning:
    'Модерация вынесла вам предупреждение за нарушение правил в личных сообщениях. Пожалуйста, соблюдай правила — при повторных нарушениях возможна блокировка аккаунта.',
}
